...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="salo"
	...
	export TMUX_POWERLINE_STATUS_LEFT_LENGTH="65"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/salo/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/salo/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/salo/.now_playing.log"
